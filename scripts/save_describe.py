...
It looks for train CSVs under `data/railway-opendata/YYYY-MM-DD/trains.csv` and uses `data/stations.csv`.
...
from src.analysis.load_data import read_train_csv, read_station_csv, tag_lines

DATA_ROOT = Path('data/railway-opendata')
